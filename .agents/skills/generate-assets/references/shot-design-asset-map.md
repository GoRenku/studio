...
| `movement-tracking` | Person included | Side-profile woman walking along a garden path or terrace, with foreground hedges/columns and background facade. | Camera travels sideways with her on a dolly or slider, keeping her nearly the same size and screen position as she walks left to right. Do not use a locked-off static camera or a fixed-point pan. | Show subject-following translation and foreground/background parallax. |
| `movement-push-in` | Person included | Medium-wide centered frame of the woman near garden steps, terrace, or arched doorway. She should be noticeably closer than an establishing wide shot, roughly full-body to knees-up, with strong foreground flowers, path stones, railings, and background facade depth around her. | Camera physically moves forward on a dolly for 4 seconds toward her. The subject should grow clearly but gracefully; foreground flowers/path/railings should grow faster than the background facade, creating visible parallax and perspective change. Do not use optical zoom or digital crop. | Show attention moving toward a subject through real camera travel. |
| `movement-pull-out` | Group included | Tight starting frame on three people standing together in front of the hotel, cropped as a close group portrait with only small hints of the exterior behind them. | Camera physically retreats backward from the still group for 4 seconds, revealing the garden grounds, fountain or path, and hotel facade around them. The group becomes smaller in frame while foreground flowers/path/railings separate from the background with visible parallax. Do not use a zoom-out or digital crop. | Show location context revealed around a group through real camera travel. |
| `movement-zoom` | No person | First-person point of view near the hotel entrance door, looking slightly upward. The carved founding year `1825` sits above the door but starts small and not yet dominant; frame begins close enough that a fast 4-second optical zoom can make the year nearly fill the frame without an impossible rush. | Optical zoom changes lens focal length while the camera stays physically fixed. The zoom is fast and includes only a slight upward tilt, like someone entering the hotel and looking up. No dolly movement, no forward travel, and no parallax. | Show lens magnification used to direct attention to a detail, distinct from a push-in. |
