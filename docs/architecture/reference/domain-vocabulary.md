...
| Cast Character Sheet | A cast image asset used as a reusable design reference for the cast member. | Attached with role `character-sheet`; generated by `cast.character-sheet` and reusable for storyboard or final-video continuity. |
