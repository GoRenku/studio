...
| Cast Character Sheet | A cast image asset used as a reusable design reference for the cast member. | Attached with role `character_sheet`; generated by media purpose `cast.character-sheet`. New imports require `referenceName` and `purpose`. |
