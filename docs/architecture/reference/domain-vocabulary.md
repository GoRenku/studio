...
| Canonical term        | Use for                                                                                                   | Notes                                                                                                                                                     |
| --------------------- | --------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Asset                 | A registered content item in Renku Studio metadata.                                                       | The `asset` row owns identity, canonical type, media kind, title, summary, reference name, ordered tags, locale, origin, availability, and timestamps. Tags are opaque intended-use strings stored as a non-null JSON list. |
