...
| Scene Shot Video Take deletion | `sceneShotVideoTake.delete` discards the take and its take-owned workspace. Take-owned media may be discarded only when no other active take input or take video references the same asset/file. | Copied take iterations must not share take-owned media assets/files. If invalid shared ownership exists, Core must report or repair it deliberately instead of discarding media out from under another active take. See `../shot-video-take-owned-media.md`. |
