...
>
> **Decision 0088 update:** the import destination is derived exclusively from
> the exact source Asset's current durable type and relationships. Agents no
> longer supply a separate destination.
