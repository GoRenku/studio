...
> **Decision 0090 update:** Shot Plan video context now uses every selected
> exact Shot Plan Dialogue Audio Take, preserving each stored Turn range as one
> reference. Weak context and independent Asset ownership remain.
