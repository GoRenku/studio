...
/**
 * Internal handler factories for Studio-owned engine models.
 *
 * This first extraction intentionally excludes legacy Renku timeline/export
 * producers. Add entries here only for engine-layer handlers that do not depend
 * on old execution plans, event logs, Remotion, or final movie assembly.
 */
