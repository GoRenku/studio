...
import type { MappingFieldDefinition } from '#core';
...
describe('YAML Mapping Transforms Integration', () => {
   ...
   * Migrated from image text-to-image producer mapping examples (seedream/v4)
   */
   ...
   * Migrated from video text-to-video producer mapping examples (LTX models)
   */
   ...
   * Migrated from image text-to-image producer mapping examples (qwen models)
   */
   ...
   * Migrated from video text-to-video producer mapping examples
   */
