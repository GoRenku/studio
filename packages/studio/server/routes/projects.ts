...
export type ProjectsRouteProjectData = Pick<
  ...
  | 'buildLookbookSheetContext'
  | 'listLookbookSheetModels'
  | 'validateLookbookSheetSpec'
  | 'createLookbookSheetSpec'
  | 'updateLookbookSheetSpec'
  | 'readLookbookSheetSpec'
  | 'listLookbookSheetSpecs'
  | 'prepareLookbookSheetSpec'
  | 'estimateLookbookSheetSpec'
  | 'runLookbookSheetSpec'
