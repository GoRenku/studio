import { IMAGE_CREATE_GENERATION_PURPOSE } from '../../../client/index.js';
...
export async function resolveImageCreateGenerationOutput(
  input: GenerationOutputResolverInput<typeof IMAGE_CREATE_GENERATION_PURPOSE>
