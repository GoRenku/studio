...
export const shotPlanVideoReferencePurpose = defineGenerationPurpose({
  purpose: 'shot-plan.video-reference',
  targetKind: 'project',
  ...
  async buildReferenceGuide(context) {
    ...
    return buildShotPlanVideoReferenceGuide({ context, slots });
  },
});
